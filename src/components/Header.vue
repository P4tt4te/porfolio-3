...
export default {
  data() {
    return { langue: this.$i18n.locale, menu: false};
...
<template>
    <header data-scroll-section class="flex justify-between">
        <nav class="flex space-x-5">
          <svg @click="animmenu()" width="125" height="116" viewBox="0 0 125 116" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="flex space-x-5">
            <img @click="changeLanguage($i18n.locale)" src="/src/assets/header/flags/france.svg" alt="">
