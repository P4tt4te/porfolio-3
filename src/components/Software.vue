...
export default defineComponent({
    data() {
        return { devs: [{ name: 'HTML/CSS/JS'},{ name: 'Typescript'},{ name: 'Next.js'},{ name: 'React.js'},{ name: 'Vue.js'},{ name: 'Node.JS'},{ name: 'SQL - NoSQL'},{ name: 'Webflow (CMS)'},{ name: 'Storybook'}], graphics: [{ name: 'Figma'},{ name: 'Affinity'},{ name: 'Photoshop'},{ name: 'Illustrator'},{ name: 'Da Vinci Resolve'},{ name: 'Premier Pro'},{ name: 'Blender'}]}
    }
})
</script>
...
<template>
    ...
    <div :id="'Software'"  data-scroll-section class="flex flex-col space-y-16 lg:space-y-20 lg:px-24 xl:px-32">
        ...
        <div data-scroll class="flex flex-col-reverse sm:flex-row justify-between">
            ...
            <div data-scroll data-scroll-speed="3" class="relative flex flex-row mb-10 sm:mb-0 justify-end">
                <p class="font-Sunydale text-3xl lg:text-4xl xl:text-5xl absolute right-9 sm:right-12 md:right-14 top-8 sm:top-28 md:top-36 lg:top-32 xl:top-44 xl:right-20 text-white">Graphic</p>
                <img class="w-36 sm:w-1/2 xl:w-3/4" src="/src/assets/software/blob2.svg" alt="">
            </div>
        </div>
    </div>
